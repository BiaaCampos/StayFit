...
<div class="container container-geral" style="max-width: 100%;">
    <div class="fundo_agendarConsulta">
                            ...
                            <div class="card-profissionais-container">
                                <div tabindex="0" class="e-card card-profissionais" id="basic_card" role="button">
                                    ...
                                    <div class="e-card-actions">
                                        ...
                                        <button class="e-btn e-outline e-primary" role="button" @click="$refs.modal.openModal()">
                                            Selecionar
                                        </button>
                                    </div>
                                </div>
        ...
        <!-- Repetir a seção de Card conforme necessário -->
        <div class="col-lg-12 control-section card-control-section basic_card_layout">
            <div class="e-card-resize-container">       
                <div class='row'>
                    <div class="row card-layout">
                            ...
                            <div class="card-profissionais-container">
                                <div tabindex="0" class="e-card card-profissionais" id="basic_card" role="button">
                                    ...
                                    <div class="e-card-actions">
                                        ...
                                        <button class="e-btn e-outline e-primary" role="button" @click="$refs.modal2.openModal()">
        ...
        <div id="linearsegment" style="margin: 20px auto; width: 50%;">
            <!-- Linear Progress Bar will be appended here -->
        </div>
        <!-- End Card Section -->
    </div>    
</div>
...
Vue.component('AppVue', {
    ...
    data: function() {
        return {
            ...
            totalPages: 3,
            errorProgress: null,
            tipomodalinfo: "Aqui estão as informações do modal!", // Mensagem para o modal
